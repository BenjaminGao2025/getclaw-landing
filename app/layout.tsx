...
export const metadata: Metadata = {
  title: "GetClaw - Professional OpenClaw Deployment",
  description:
    "Professional OpenClaw deployment and management services. Security-first setup for founders and teams. Based in Vancouver, serving globally.",
};
